...
public class RootUserServlet extends HttpServlet {
    ...
    private void connectToDatabase() {
        try {
            ...
            props.load(new FileInputStream("C:/Program Files/Apache Software Foundation/Tomcat 10.1/webapps/Project-4/WEB-INF/lib/root.properties"));
            ...
            if (connection != null) {
                statement = connection.createStatement(); // Initialize statement object here
            } else {
    ...
    private String doUpdate(String sqlStatement) throws SQLException {
        ...
        try (Statement statement = connection.createStatement()) {
            int rowUpdates = statement.executeUpdate(sqlStatement);
